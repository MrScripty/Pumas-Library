...
| `backend-owned-status-resource-telemetry/plan.md` | Plan for replacing idle status/resource polling with backend-owned cached telemetry snapshots and push updates through the existing Rust RPC, Electron, and frontend subscription path. |
