# Torch v2.14.0 current-source macOS CPU/Core RPC acceptance

The native RPC E2E job in [workflow run 36229508586](https://github.com/MrScripty/Pumas-Library/actions/runs/36229508586)
passed on code commit `21041697` for macOS arm64 (macos-15). It discovered `v2.14.0`,
...
`14` with Torch `2.14.0` on device `cpu`.

The run installed Pumas-managed CPython 3.14.7 for `aarch64-apple-darwin` using the
