...
class LauncherUpdater:
    ...
    def __init__(self, metadata_manager, repo_owner="MrScripty", repo_name="Linux-ComfyUI-Launcher"):
        ...
        self.cache_file = self.launcher_root / 'launcher-data' / 'cache' / 'launcher-update-check.json'
    ...
    def apply_update(self, progress_callback: Optional[Callable] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if progress_callback:
                progress_callback({'stage': 'backup', 'message': 'Recording current version...', 'percent': 10})

            # Step 2: Pull latest changes
            if progress_callback:
                progress_callback({'stage': 'pull', 'message': 'Fetching updates from GitHub...', 'percent': 20})
            ...
            if 'Already up to date' in pull_result.stdout or 'Already up-to-date' in pull_result.stdout:
                ...
                return {'success': True, 'message': 'Already up to date', 'newCommit': current_commit}
            ...
            if progress_callback:
                progress_callback({'stage': 'dependencies', 'message': 'Updating Python dependencies...', 'percent': 40})
            ...
            if progress_callback:
                progress_callback({'stage': 'npm', 'message': 'Updating frontend dependencies...', 'percent': 60})
            ...
            if progress_callback:
                progress_callback({'stage': 'build', 'message': 'Rebuilding frontend...', 'percent': 80})
            ...
            if build_result.returncode != 0:
                ...
                return {'success': False, 'error': f'Frontend build failed. Rolled back to {current_commit}.'}

            if progress_callback:
                progress_callback({'stage': 'complete', 'message': 'Update complete!', 'percent': 100})
