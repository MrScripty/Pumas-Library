...
| Torch's synchronous text handlers are not registered public chat/completion providers. Their worker lifecycle and responsiveness remain Milestone 3 work and are not a prerequisite for TIPC-M1's shared Ollama/llama.cpp gateway proof. | Milestone 3 | Current provider registry and handler inspection | Implicitly expanding TIPC-M1 into Torch text remediation |
