...
class ComfyUISetupAPI:
    ...
    def _init_managers(self):
        ...
        self.version_info_mgr = VersionInfoManager(
            self.comfyui_dir,
            self.github_fetcher
        )
    ...
    def get_available_versions(self, force_refresh: bool = False) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            self.size_calc._refresh_release_sizes_async(enriched_releases, installed_tags, force_refresh)
        except Exception as e:
