...
export function HeaderStatusBadge({ status }: { status: HeaderStatusInfo }) {
  ...
  return (
    <div className="flex-1 flex items-center justify-center min-w-0">
      <div role="status" aria-live="polite" className="flex items-center gap-1.5 px-2 py-0.5 bg-[hsl(var(--accent-success)/0.15)] rounded text-xs font-medium text-[hsl(var(--text-primary))]">
