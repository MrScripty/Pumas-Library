...
export type InstallVersionParams = ({ "app_id": string; "preview_id"?: string | null; "tag": string }) | ({ "appId": string; "preview_id"?: string | null; "tag": string });
