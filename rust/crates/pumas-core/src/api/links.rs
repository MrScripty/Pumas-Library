...
impl PumasApi {
    /// Get the health status of all registered model links.
    ///
    /// The version argument currently does not filter this registry-wide read.
    /// Unregistered orphan files are outside the report's scope.
