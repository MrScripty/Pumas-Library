...
| `onnx_runtime/mod.rs` is close to the 500-line standards threshold after adding real-session and postprocess exports. | Medium | Do not add more ONNX execution surface directly to the entrypoint; split contracts, inference, and tests into focused modules before wiring real inference. |
