# Torch v2.14.0 current-source Windows CPU/Core RPC acceptance

The native RPC E2E job in [workflow run 36229508586](https://github.com/MrScripty/Pumas-Library/actions/runs/36229508586)
passed on code commit `21041697` for Windows x86_64 (windows-2025). It discovered `v2.14.0`,
...
The run installed Pumas-managed CPython 3.14.7 for `x86_64-pc-windows-msvc` using the
